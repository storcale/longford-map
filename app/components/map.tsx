...
import { MapContainer, Marker, Popup, TileLayer, ZoomControl,GeoJSON } from "react-leaflet";
import { geoJSON, LatLng, LatLngBounds } from "leaflet"

/* const countyLayer: GeoJsonObject = {
...
export default function Map() {
    const borderStyle = {
        color: "red", // Red color for the border
        weight: 2,    // Thickness of the border
        fillOpacity: 0, // No fill, only the border is visible
      };
    ...
    return (
        <div>
            ...
            >
                ...
                {/*<GeoJSON data={countyLayer} style={borderStyle} />*/}
            </MapContainer>
        </div>
    );
}
